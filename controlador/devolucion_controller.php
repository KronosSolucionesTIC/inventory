        ...
        if ($permisos[0]["consultar"] == 1) {
            if (isset($listaDevolucion)) {
                for ($i = 0; $i < sizeof($listaDevolucion); $i++) {
                    ...
                    echo '<td style="cursor: pointer" class="detalle" name="btn_detalle" title="Click Ver Detalles" data-id-equipo="' . $listaDevolucion[$i]["id_devolucion"] . '">' . $listaDevolucion[$i]["url_devolucion"] . '</td>';
