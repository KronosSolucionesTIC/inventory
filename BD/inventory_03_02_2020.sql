...
(2, 20, 1, 0, NULL, NULL, NULL, 'CREACIÓN DE EQUIPO', 0),
(3, 21, 1, 0, NULL, NULL, NULL, 'CREACIÓN DE EQUIPO', 0);
...
--
ALTER TABLE `historico_equipo`
  MODIFY `id_historico_equipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
