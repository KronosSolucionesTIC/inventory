...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2020 a las 23:02:35
...
(1, '2020-01-31', 1, 1, 53, 1, 10, 'prueba', 1);
...
INSERT INTO `historico_equipo` (`id_historico_equipo`, `fecha_historico_equipo`, `fkID_equipo`, `fkID_persona_entrega`, `fkID_persona_recibe`, `fkID_tipo_movimiento`, `fkID_area`, `url_historico_equipo`, `obs_historico_equipo`, `conse_historico_equipo`, `estado`) VALUES
(1, '2020-01-27', 19, 1, 1, 6, 0, NULL, 'CREACIÓN DE EQUIPO', '-1', 0);
...
(1, 19, 1, 0, NULL, NULL, NULL, 'CREACIÓN DE EQUIPO', 0);
...
(52, '54321', '348162101fc6f7e624681b7400b085eeac6df7bd', 11, '', 0, 1),
...
--
ALTER TABLE `historico_equipo`
  MODIFY `id_historico_equipo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `territorial_proyecto`
  MODIFY `id_territorial_proyecto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
